          ...
          <article className="prose prose-neutral dark:prose-invert max-w-none">
            ...
            <section className="mb-8 space-y-4">
              ...
              <p className="text-foreground/90 leading-relaxed">
                ...
                Pascal Editor and Platform at pascal.app. This Privacy Policy explains how we
            ...
            <section className="mb-8 space-y-4">
              ...
              <p className="text-foreground/90 leading-relaxed">
                ...
                including page views, performance metrics, and general usage patterns. This helps us
            ...
            <section className="mb-8 space-y-4">
              ...
              <ul className="list-disc space-y-2 pl-6 text-foreground/90">
                ...
                <li>
                  Send optional email notifications about new features and updates (you can opt out
                  in settings)
                </li>
            ...
            <section className="mb-8 space-y-4">
              ...
              <ul className="list-disc space-y-2 pl-6 text-foreground/90">
                ...
                <li>
                  <strong>Vercel</strong> - Application hosting, analytics, and performance
                  monitoring
                </li>
                <li>
              ...
              <p className="mt-4 text-foreground/90 leading-relaxed">
                Each of these services has their own privacy policies governing their handling of
                your data.
              </p>
            </section>
            ...
            <section className="mb-8 space-y-4">
              ...
              <p className="text-foreground/90 leading-relaxed">
                ...
                account, we will delete your personal data and project data within 30 days, except
