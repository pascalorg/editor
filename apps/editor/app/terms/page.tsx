          ...
          <article className="prose prose-neutral dark:prose-invert max-w-none">
            ...
            <section className="mb-8 space-y-4">
              ...
              <p className="text-foreground/90 leading-relaxed">
                ...
                (&quot;Platform&quot;), operated by Pascal Group Inc. (&quot;we,&quot;
                &quot;us,&quot; or &quot;our&quot;). By accessing or using our services, you agree
            ...
            <section className="mb-8 space-y-4">
              ...
              <p className="text-foreground/90 leading-relaxed">
                The Pascal Editor is open-source software released under the MIT License. You may
                use, copy, modify, merge, publish, distribute, sublicense, and/or sell copies of the
                Editor software in accordance with the MIT License terms.
              </p>
              <p className="text-foreground/90 leading-relaxed">
                The Pascal platform (pascal.app) and its associated services, including user
                accounts, cloud storage, and project hosting, are proprietary services owned and
                operated by Pascal Group Inc. These Terms govern your use of the Platform.
              </p>
            </section>
            ...
            <section className="mb-8 space-y-4">
              ...
              <p className="text-foreground/90 leading-relaxed">
                ...
                maintaining the security of your account credentials and for all activities that
            ...
            <section className="mb-8 space-y-4">
              ...
              <p className="text-foreground/90 leading-relaxed">
                ...
                the Platform (&quot;Your Content&quot;). By using the Platform, you grant us a
                limited license to store, display, and transmit Your Content solely to provide our
                services to you.
              </p>
              <p className="text-foreground/90 leading-relaxed">
            ...
            <section className="mb-8 space-y-4">
              ...
              <p className="text-foreground/90 leading-relaxed">
                ...
                or engage in conduct that we determine is harmful to the Platform or other users.
            ...
            <section className="mb-8 space-y-4">
              ...
              <p className="text-foreground/90 leading-relaxed">
                TO THE MAXIMUM EXTENT PERMITTED BY LAW, PASCAL GROUP INC. SHALL NOT BE LIABLE FOR
            ...
            <section className="mb-8 space-y-4">
              ...
              <p className="text-foreground/90 leading-relaxed">
                ...
                by posting the updated Terms on the Platform. Your continued use of the Platform
