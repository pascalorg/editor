...
import { createUserSchema, type CreateUserResponse, type UsersListResponse } from '@panel/lib/api-contract';
...
import { createInvitedUser, getUserDetail, listUsers, siteNames, type UserSortKey } from '@panel/lib/users';
...
export const POST = handler(async (request: Request) => {
  ...
  await deliverInvite({ email, fullName, token: issued.token, expiresAt: issued.invitation.expiresAt });
