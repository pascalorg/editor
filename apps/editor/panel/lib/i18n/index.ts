...
export function resolveApiMessage(
  ...
  const map: Record<string, string> = {
    ...
    'err.userReferenced': dict.errUserReferenced,
    'err.externalNotAllowed': dict.errExternalNotAllowed,
    'err.inviteNotResendable': dict.errInviteNotResendable,
    'err.inviteNotRevocable': dict.errInviteNotRevocable,
    'err.jobNotCancellable': dict.errJobNotCancellable,
    'err.jobNotRetryable': dict.errJobNotRetryable,
    'err.keyNotRevocable': dict.errKeyNotRevocable,
    'err.mfaAlreadyEnrolled': dict.errMfaAlreadyEnrolled,
    'err.notFound': dict.errNotFound,
    'err.requestDecided': dict.errRequestDecided,
    'err.roleExists': dict.errRoleExists,
    'err.siteStateUnchanged': dict.errSiteStateUnchanged,
    'err.systemRoleLocked': dict.errSystemRoleLocked,
    'err.userExists': dict.errUserExists,
