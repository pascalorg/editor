...
/**
 * Roof node schema - extends BaseNodeSchema with roof-specific properties
 */
export const RoofNodeSchema = createNodeSchema(
  'roof',
  {
  ...
  {
    withGrid: true,
    // Children can be roof segments (will be validated by their own schemas)
...
// Register the schema
registerNodeSchema('roof', RoofNodeSchema)
