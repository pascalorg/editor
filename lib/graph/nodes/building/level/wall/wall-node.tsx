...
import { createNodeSchema, GridPointSchema, registerNodeSchema } from '@/lib/graph/schema'
...
/**
 * Wall node schema - extends BaseNodeSchema with wall-specific properties
 */
export const WallNodeSchema = createNodeSchema(
  'wall',
  {
    start: GridPointSchema,
    end: GridPointSchema,
  },
  {
    withGrid: true,
    // Children can be doors or windows (will be validated by their own schemas)
    childrenSchema: z.lazy(() => z.array(z.any())),
  },
)
...
// Register the schema
registerNodeSchema('wall', WallNodeSchema)
