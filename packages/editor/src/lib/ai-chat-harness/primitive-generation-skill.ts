...
- Complete-family requests and component requests are different intents. Use compose_assembly only when the user explicitly asks for the whole object: "a car", "one vehicle", "complete pump", "whole fan", etc. If the user names a component, subpart, accessory, or internal/external part, generate only that component.
- Family-qualified part requests are single parts: "car steering wheel", "car wheel", "aircraft wing", "pump impeller", and "fan blade" mean generate only that component. Treat the family word as context only; do not expand the parent family into a complete vehicle, aircraft, pump, fan, or machine.
- If no dedicated reusable part kind exists for a requested component, use compose_primitive or generic compose_parts primitives. Do not add a new kind or invent a parent assembly just because the component belongs to a known family.
- Constraint-first generic assembly: vehicles, outdoor AC units, machine tools (lathe/milling/grinder/planer/drill/CNC), pumps, conveyors, fans, tanks, distillation/chemical towers or columns, reactors, compressors, grate coolers, electrical cabinets, and broad industrial equipment, but only for complete-object intents. Plain chimneys/smokestacks are not assembly towers; use compose_parts with chimney_stack, not vertical_pole/circular_base or raw cylinders.
...
- Reusable part kernel: fans, pumps/blowers, chimney_stack smokestacks, pipe ports/flanges, vent_grill/vent_slats, rounded_machine_body, tanks, desks, cabinets, bicycles, generic wheels/windows/lights/body shells, shaft + hub + blades, hemisphere half-spheres/domes, ellipsoid_shell domes/covers, curved_panel/curved_lens_panel, ergonomic shells, airfoil blades, streamlined bodies, lofted_shell/lofted_panel transitions, aircraft_fuselage complete aircraft defaults, pyramid shapes (use pyramid part for square/rectangular pyramids, pointed rooftops, gem shapes, and cone-like forms with a square base; set truncated:true or topScale to flatten the apex).
- For complete fans, prefer fan_blade with count:3-6 so each blade is independently selectable/editable. Use radial_blades only for legacy compatibility.
...
- For car steering wheel / 汽车方向盘, use compose_primitive shapes: torus wheel_rim, cylinder center_hub, and three box/capsule spoke shapes. Use shapes:[{kind:"torus", ...}], not primitives:[...] and not kind:"primitive".
- For a complete bicycle / 自行车, use compose_parts with the canonical part plan: wheel_set semanticRole:"bicycle_tire" count:2, tube_frame semanticRole:"bicycle_frame", fork semanticRole:"bicycle_fork", handlebar, saddle, and chain_loop. Do not invent bicycle_crank, bicycle_chainring, bicycle_pedals, bicycle_handlebar, or bicycle_seat part kinds; crank, chainring, and pedals are details generated by the bicycle frame/chain kernels.
