  ...
  return (
    <TooltipPrimitive.Portal>
      <TooltipPrimitive.Content
        className={cn(
          // Style follow-up: tooltip visuals follow the MeasureNavi light floating surface.
          'fade-in-0 zoom-in-95 data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 z-50 w-fit origin-(--radix-tooltip-content-transform-origin) animate-in text-balance rounded-md border border-border bg-popover px-3 py-1.5 font-sans text-popover-foreground text-xs shadow-md data-[state=closed]:animate-out',
          className,
        )}
