...
export const CATALOG_ITEMS: AssetInput[] = [
  ...
  },
  {
    ...
    category: 'appliance',
    name: '宽体双门冰箱',
    tags: ['refrigerator', 'fridge', 'kitchen', 'appliance', 'floor', 'against-wall', 'custom'],
    thumbnail: '/icons/couch.png',
    src: '/items/refrigerator-04/model.glb',
    dimensions: [0.908, 1.746, 0.885],
    offset: [0, 0, 0],
    rotation: [0, 0, 0],
    scale: [1, 1, 1],
  },
  {
    ...
    tags: ['refrigerator', 'fridge', 'kitchen', 'appliance', 'floor', 'against-wall', 'custom'],
    thumbnail: '/icons/couch.png',
    src: '/items/refrigerator-05/model.glb',
    dimensions: [0.546, 1.818, 0.553],
    offset: [0, 0, 0],
    rotation: [0, 0, 0],
    scale: [1, 1, 1],
  },
  {
    ...
    category: 'furniture',
    name: '1.5 米书桌',
    tags: ['desk', 'study', 'office', 'workstation', 'floor', 'against-wall', 'custom'],
    thumbnail: '/icons/couch.png',
    src: '/items/desk-03/model.glb',
    dimensions: [1.5, 0.762, 0.65],
  ...
  },
  {
    ...
    category: 'furniture',
    name: '2.2 米加长书桌',
    tags: ['desk', 'study', 'office', 'workstation', 'double-workstation', 'floor', 'against-wall', 'custom'],
    thumbnail: '/icons/couch.png',
    src: '/items/desk-04/model.glb',
    dimensions: [2.23, 0.85, 0.85],
    offset: [0, 0, 0], rotation: [0, 0, 0], scale: [1, 1, 1],
  },
  {
    id: 'desk-05',
    ...
    tags: ['desk', 'study', 'office', 'workstation', 'floor', 'against-wall', 'custom'],
    thumbnail: '/icons/couch.png',
    src: '/items/desk-05/model.glb',
    dimensions: [1.468, 0.743, 1.1],
    offset: [0, 0, 0], rotation: [0, 0, 0], scale: [1, 1, 1],
  },
  {
    id: 'desk-06',
    ...
    tags: ['desk', 'study', 'office', 'workstation', 'floor', 'against-wall', 'custom'],
    thumbnail: '/icons/couch.png',
    src: '/items/desk-06/model.glb',
    dimensions: [1.524, 0.737, 0.711],
    offset: [0, 0, 0], rotation: [0, 0, 0], scale: [1, 1, 1],
  },
  {
    id: 'desk-07',
    category: 'furniture',
    name: '1.3 米紧凑书桌',
    tags: ['desk', 'study', 'office', 'workstation', 'compact', 'floor', 'against-wall', 'custom'],
    thumbnail: '/icons/couch.png',
    src: '/items/desk-07/model.glb',
    dimensions: [1.31, 0.76, 0.6],
    offset: [0, 0, 0], rotation: [0, 0, 0], scale: [1, 1, 1],
  },
  {
    id: 'desk-08',
    ...
    tags: ['desk', 'study', 'office', 'workstation', 'floor', 'against-wall', 'custom'],
    thumbnail: '/icons/couch.png',
    src: '/items/desk-08/model.glb',
    dimensions: [1.4, 0.75, 0.65],
    offset: [0, 0, 0], rotation: [0, 0, 0], scale: [1, 1, 1],
  },
  {
    id: 'desk-09',
    ...
    tags: ['desk', 'study', 'office', 'workstation', 'floor', 'against-wall', 'custom'],
    thumbnail: '/icons/couch.png',
    src: '/items/desk-09/model.glb',
    dimensions: [1.6, 0.74, 0.738],
    offset: [0, 0, 0], rotation: [0, 0, 0], scale: [1, 1, 1],
  },
  {
    id: 'sofa-s-03',
    category: 'furniture',
    name: '紧凑单人沙发',
    tags: ['sofa', 'armchair', 'seating', 'living-room', 'floor', 'against-wall', 'custom'],
    thumbnail: '/icons/couch.png',
    src: '/items/sofa-s-03/model.glb',
    dimensions: [0.85, 0.674, 0.815],
    offset: [0, 0, 0], rotation: [0, 0, 0], scale: [1, 1, 1],
  },
  {
    id: 'sofa-s-04',
    ...
    tags: ['sofa', 'armchair', 'seating', 'living-room', 'floor', 'against-wall', 'custom'],
    thumbnail: '/icons/couch.png',
    src: '/items/sofa-s-04/model.glb',
    dimensions: [1.08, 0.81, 0.925],
    offset: [0, 0, 0], rotation: [0, 0, 0], scale: [1, 1, 1],
  },
  {
    id: 'sofa-s-05',
    ...
    tags: ['sofa', 'armchair', 'seating', 'living-room', 'floor', 'against-wall', 'custom'],
    thumbnail: '/icons/couch.png',
    src: '/items/sofa-s-05/model.glb',
    dimensions: [0.747, 0.842, 0.985],
    offset: [0, 0, 0], rotation: [0, 0, 0], scale: [1, 1, 1],
  },
  {
    id: 'sofa-s-06',
    ...
    tags: ['sofa', 'armchair', 'seating', 'living-room', 'floor', 'against-wall', 'custom'],
    thumbnail: '/icons/couch.png',
    src: '/items/sofa-s-06/model.glb',
    dimensions: [0.9, 1.164, 0.92],
    offset: [0, 0, 0], rotation: [0, 0, 0], scale: [1, 1, 1],
  },
  {
    id: 'sofa-s-07',
    category: 'furniture',
    name: '迷你单人沙发',
    tags: ['sofa', 'armchair', 'seating', 'living-room', 'compact', 'floor', 'against-wall', 'custom'],
    thumbnail: '/icons/couch.png',
    src: '/items/sofa-s-07/model.glb',
    dimensions: [0.5, 0.636, 0.5],
    offset: [0, 0, 0], rotation: [0, 0, 0], scale: [1, 1, 1],
  },
  {
    id: 'coffee-table-01',
    category: 'furniture',
    name: '1.2 米长方茶几',
    tags: ['coffee-table', 'tea-table', 'living-room', 'table', 'floor', 'custom'],
    thumbnail: '/icons/couch.png', src: '/items/coffee-table-01/model.glb',
    dimensions: [1.2, 0.45, 0.5], offset: [0, 0, 0], rotation: [0, 0, 0], scale: [1, 1, 1],
  },
  {
    id: 'coffee-table-02',
    category: 'furniture',
    name: '超低长方茶几',
    tags: ['coffee-table', 'tea-table', 'living-room', 'table', 'low-profile', 'floor', 'custom'],
    thumbnail: '/icons/couch.png', src: '/items/coffee-table-02/model.glb',
    dimensions: [1.2, 0.24, 0.75], offset: [0, 0, 0], rotation: [0, 0, 0], scale: [1, 1, 1],
  },
  {
    id: 'coffee-table-03',
    category: 'furniture',
    name: '1.55 米长方茶几',
    tags: ['coffee-table', 'tea-table', 'living-room', 'table', 'floor', 'custom'],
    thumbnail: '/icons/couch.png', src: '/items/coffee-table-03/model.glb',
    dimensions: [1.549, 0.356, 0.635], offset: [0, 0, 0], rotation: [0, 0, 0], scale: [1, 1, 1],
  },
  {
    id: 'coffee-table-04',
    category: 'furniture',
    name: '低矮长方茶几',
    tags: ['coffee-table', 'tea-table', 'living-room', 'table', 'low-profile', 'floor', 'custom'],
    thumbnail: '/icons/couch.png', src: '/items/coffee-table-04/model.glb',
    dimensions: [1.2, 0.32, 0.445], offset: [0, 0, 0], rotation: [0, 0, 0], scale: [1, 1, 1],
  },
  {
    id: 'coffee-table-05',
    category: 'furniture',
    name: '方形茶几',
    tags: ['coffee-table', 'tea-table', 'living-room', 'table', 'square', 'floor', 'custom'],
    thumbnail: '/icons/couch.png', src: '/items/coffee-table-05/model.glb',
    dimensions: [1, 0.42, 1], offset: [0, 0, 0], rotation: [0, 0, 0], scale: [1, 1, 1],
  },
  {
    id: 'coffee-table-06',
    category: 'furniture',
    name: '1.25 米长方茶几',
    tags: ['coffee-table', 'tea-table', 'living-room', 'table', 'floor', 'custom'],
    thumbnail: '/icons/couch.png', src: '/items/coffee-table-06/model.glb',
    dimensions: [1.256, 0.5, 0.6], offset: [0, 0, 0], rotation: [0, 0, 0], scale: [1, 1, 1],
  },
  {
    id: 'dining-table-03',
    category: 'furniture',
    name: '2.25 米长餐桌',
    tags: ['dining-table', 'dining', 'table', 'kitchen', 'six-seat', 'floor', 'custom'],
    thumbnail: '/icons/couch.png', src: '/items/dining-table-03/model.glb',
    dimensions: [2.25, 0.741, 0.851], offset: [0, 0, 0], rotation: [0, 0, 0], scale: [1, 1, 1],
  },
  {
    id: 'dining-table-04',
    category: 'furniture',
    name: '2.5 米加长餐桌',
    tags: ['dining-table', 'dining', 'table', 'kitchen', 'eight-seat', 'floor', 'custom'],
    thumbnail: '/icons/couch.png', src: '/items/dining-table-04/model.glb',
    dimensions: [2.5, 0.76, 1], offset: [0, 0, 0], rotation: [0, 0, 0], scale: [1, 1, 1],
  },
  {
    id: 'dining-table-05',
    category: 'furniture',
    name: '2.4 米大餐桌',
    tags: ['dining-table', 'dining', 'table', 'kitchen', 'eight-seat', 'floor', 'custom'],
    thumbnail: '/icons/couch.png', src: '/items/dining-table-05/model.glb',
    dimensions: [2.4, 0.75, 1.3], offset: [0, 0, 0], rotation: [0, 0, 0], scale: [1, 1, 1],
  },
  {
    id: 'dining-table-06',
    category: 'furniture',
    name: '四人餐桌',
    tags: ['dining-table', 'dining', 'table', 'kitchen', 'four-seat', 'floor', 'custom'],
    thumbnail: '/icons/couch.png', src: '/items/dining-table-06/model.glb',
    dimensions: [1.36, 0.79, 0.8], offset: [0, 0, 0], rotation: [0, 0, 0], scale: [1, 1, 1],
  },
  {
    id: 'dining-table-07',
    category: 'furniture',
    name: '2.5 米窄面餐桌',
    tags: ['dining-table', 'dining', 'table', 'kitchen', 'eight-seat', 'floor', 'custom'],
    thumbnail: '/icons/couch.png', src: '/items/dining-table-07/model.glb',
    dimensions: [2.5, 0.71, 1], offset: [0, 0, 0], rotation: [0, 0, 0], scale: [1, 1, 1],
  },
  {
    id: 'dining-table-08',
    category: 'furniture',
    name: '1 米方形餐桌',
    tags: ['dining-table', 'dining', 'table', 'kitchen', 'four-seat', 'square', 'floor', 'custom'],
    thumbnail: '/icons/couch.png', src: '/items/dining-table-08/model.glb',
    dimensions: [1.04, 0.745, 1.04], offset: [0, 0, 0], rotation: [0, 0, 0], scale: [1, 1, 1],
  },
