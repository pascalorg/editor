...
export function applyCustomMeshPreviewPose(
  mesh: Object3D,
...
export function resolveCustomMeshFaceSwitch(
...
export function clampCustomMeshFacePosition(
  position: Vector3Tuple,
  bounds: FaceBounds,
...
export function clampCustomMeshFaceCenterPosition(
  position: Vector3Tuple,
  bounds: FaceBounds,
