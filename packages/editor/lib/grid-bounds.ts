...
//   // Check walls
//   // TODO: use node index by level and spatial grid to find walls
//   const wallComponent = components.find((c) => c.type === 'wall' && c.parentId === floorId)
//   if (wallComponent && wallComponent.type === 'wall') {
//     for (const wall of wallComponent.children) {
