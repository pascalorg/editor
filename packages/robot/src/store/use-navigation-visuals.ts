...
type NavigationItemDeleteActivation = {
  fadeStartedAtMs: number | null
  startedAtMs: number
}

type NavigationItemMovePreview = {
  id: ItemNode['id']
...
type NavigationRuntimeVisualState = {
  ...
  setNavigationPostWarmupScope: (scope: NavigationPostWarmupScope) => void
}
