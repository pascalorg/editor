...
const UNSEEDED_SYSTEMS: Record<string, UnseededFormworkSystem> = {
  'mivan-generic': unseeded(
    ...
    { walls: true, columns: false, slabs: true },
  ...
  'peri-srs': unseeded(
    ...
    { walls: false, columns: true, slabs: false },
  ...
  'peri-skydeck': unseeded(
    ...
    { walls: false, columns: false, slabs: true },
  ...
  'doka-frami': unseeded(
    ...
    { walls: true, columns: true, slabs: false },
...
function unseeded(
  ...
  manufacturer: string,
  label: string,
  supports: { walls: boolean; columns: boolean; slabs: boolean },
