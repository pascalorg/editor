...
```bash
npm install @vesper/viewer @vesper/core
```
...
```typescript
import { Viewer, useViewer } from '@vesper/viewer'
...
```typescript
import { Viewer } from '@vesper/viewer'
...
```typescript
import { resolveCdnUrl, ASSETS_CDN_URL } from '@vesper/viewer'
