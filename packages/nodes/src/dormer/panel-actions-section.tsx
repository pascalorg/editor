...
import { ActionButton, ActionGroup, PanelSection, useTranslations } from '@pascal-app/editor'
...
export function DormerActionsSection({
  ...
  return (
    <PanelSection title={t('common.actions')}>
      <ActionGroup>
        <ActionButton icon={<Move className="h-3.5 w-3.5" />} label={t('common.move')} onClick={onMove} />
        <ActionButton
