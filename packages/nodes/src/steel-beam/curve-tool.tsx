...
export const CurveSteelBeamTool: React.FC<{ node: SteelBeamNode }> = ({ node }) => {
  ...
  useEffect(() => {
    ...
    const applyPreview = (curveOffset: number) => {
      ...
      setCursorLocalPos([handlePoint.x, node.elevation + 0.1, handlePoint.y])
...
export default CurveSteelBeamTool
