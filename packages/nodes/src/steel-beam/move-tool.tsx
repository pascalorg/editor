...
export const MoveSteelBeamTool: React.FC<{ node: SteelBeamNode }> = ({ node }) => {
  ...
  useEffect(() => {
    ...
    const mesh = sceneRegistry.nodes.get(steelBeamId)
...
export default MoveSteelBeamTool
