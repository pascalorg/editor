...
import { DataTableNode, emitter, type GridEvent, sceneRegistry, useScene } from '@pascal-app/core'
...
export default function DataTableTool() {
  ...
  useEffect(() => {
    ...
    const onGridClick = (event: GridEvent) => {
      ...
      useScene.getState().createNode(table, activeLevelId)
      useViewer.getState().setSelection({ selectedIds: [table.id] })
