 ...
 * is overhead trim: it is not on the plan (Steve, 2026-09-09: "floor plan
 * isn't legible in the plans because the roof hatch and planes cover it
 * all" — the generated fascia blocks, one per roof segment, filled the roof
 * footprint plus its overhang over every room). Level-local metres.
 */
