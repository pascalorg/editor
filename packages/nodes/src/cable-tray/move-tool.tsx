...
export const MoveCableTrayTool: React.FC<{ node: CableTrayNode }> = ({ node }) => {
  ...
  useEffect(() => {
    ...
    const mesh = sceneRegistry.nodes.get(cableTrayId)
...
export default MoveCableTrayTool
