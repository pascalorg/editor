    ...
    >
      ...
      {!isBraceSupport && (
        <PanelSection title={S.ends()}>
          ...
          {node.baseStyle === 'stepped-square' && (
            <SliderControl
              label={columnL.bottomStepSpread()}
              max={0.9}
              min={0.05}
