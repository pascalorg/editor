...
import { subscribeCameraPose, useViewer } from '@pascal-app/editor'
...
function capturePipeline(
  ...
  return new Promise((resolve) => {
    ...
    try {
      ...
      // Main's generator correlates every capture with the active project and
      // rejects a request whose project changed before the frame rendered.
      emit('camera-controls:generate-thumbnail', {
